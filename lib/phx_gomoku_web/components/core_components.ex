defmodule PhxGomokuWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhxGomokuWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhxGomokuWeb.Gettext, "errors", msg, opts)
    end
  end
